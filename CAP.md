...
As an example, Ogdolo hosts it's endpoints on the subdomain opencap.ogdolo.com on port 443.
Here the SRV record for Ogdolo.com to use as a reference:

```
_opencap._tcp.ogdolo.com. 86400 IN SRV 0 5 443 opencap.ogdolo.com.
```
